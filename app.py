...
with gr.Blocks(css="""
    ...
    footer { text-align: center; margin-top: 20px; padding: 10px; color: #666; font-size: 0.8em; }
""") as demo:
    
    gr.HTML("""
    <div class="header">
        <h1>🤖 Solarin Ayomide — Digital Twin</h1>
        <p>Chat with a digital twin of Solarin Ayomide — tech builder, full-stack developer, and digital strategist with expertise in web development, payment integrations, and agentic AI systems.</p>
    </div>
    """)
